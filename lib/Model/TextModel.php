 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TextModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TextModel';
    ...
    public function setText($text)
    {
        if ((mb_strlen($text) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TextModel., must be smaller than or equal to 3000.');
        }
